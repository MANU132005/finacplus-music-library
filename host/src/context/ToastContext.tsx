    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      >
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`p-4 rounded-2xl border flex items-start gap-3 shadow-soft bg-white border-slate-100 pointer-events-auto animate-slideUp transition-all duration-300`}
            role="alert"
          >
